...
1. Load an SP1 [`SP1ProofWithPublicValues`](https://docs.rs/sp1-sdk/latest/sp1_sdk/proof/struct.SP1ProofWithPublicValues.html)
...
- The `proof` is the Groth16 proof, serialized in [SP1's standard format](https://docs.rs/sp1-sdk/latest/sp1_sdk/proof/struct.SP1ProofWithPublicValues.html#method.bytes)
...
> SP1 6.1 Groth16 proof bytes are already 356 bytes, and public inputs can potentially be very large.
